    ...
    <div className="relative overflow-hidden bg-[#0f0f0f] text-white">
      ...
      <nav className="relative z-10 flex items-center justify-between px-8 py-5 border-b border-white/10">
        ...
        <div className="flex items-center gap-6 text-sm text-white/50">
          <Link to="/" className="hover:text-white transition-colors whitespace-nowrap cursor-pointer">Coaches</Link>
          <span className="text-white/80 font-medium whitespace-nowrap">Lateness</span>
